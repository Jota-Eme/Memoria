...
tuple<string,int,int,int,int,int,int,int,int,int,int,int,int,int> read_input(int argc, char **argv){
	...
	int iterations_grasp = stoi((char *)(argv[5]));
	int iterations_phase1 = stoi((char *)(argv[6]));
	int iterations_phase2 = stoi((char *)(argv[7]));
	int iterations_phase3 = stoi((char *)(argv[8]));
	int porc_movimiento_two_opt = stoi((char *)(argv[9]));
	int porc_movimiento_swap_cd = stoi((char *)(argv[10]));
	int porc_movimiento_swap_pickup = stoi((char *)(argv[11]));
	int porc_movimiento_swap_delivery = stoi((char *)(argv[12]));
	int porc_movimiento_change_node = stoi((char *)(argv[13]));
	int seed = stoi((char *)(argv[14]));
	
	return make_tuple(input_file,list_graps_size,tabu_capacity_size,tabu_worst_route_size,iterations_grasp,iterations_phase1,iterations_phase2,iterations_phase3,porc_movimiento_two_opt,porc_movimiento_swap_cd,porc_movimiento_swap_pickup,porc_movimiento_swap_delivery,porc_movimiento_change_node,seed);
...
int main(int argc, char *argv[]) {
	...
	if(argc != 15){
		cout<<argc<<endl;
		cout << "El formato para la ejecucion es: " << argv[0] << " archivo_entrada tamaño_lista_grasp tamaño_lista_tabu_capcity tamaño_lista_tabu_worst_route iteraciones_grasp iteraciones_phase1 iteraciones_phase2 iteraciones_phase3 porc_movimiento_two_opt porc_movimiento_swap_cd porc_movimiento_swap_pickup porc_movimiento_swap_delivery porc_movimiento_change_node semilla"<<endl;
		return 0;
	}

	string input_file;
	int list_graps_size,tabu_capacity_size,tabu_worst_route_size,seed,iterations_grasp,iterations_phase1,iterations_phase2,iterations_phase3,porc_movimiento_two_opt,porc_movimiento_swap_cd,porc_movimiento_swap_pickup,porc_movimiento_swap_delivery,porc_movimiento_change_node;

	tie(input_file,list_graps_size,tabu_capacity_size,tabu_worst_route_size,iterations_grasp,iterations_phase1,iterations_phase2,iterations_phase3,porc_movimiento_two_opt,porc_movimiento_swap_cd,porc_movimiento_swap_pickup,porc_movimiento_swap_delivery,porc_movimiento_change_node,seed) = read_input(argc,argv);
